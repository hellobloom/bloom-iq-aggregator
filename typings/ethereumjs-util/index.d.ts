declare module 'ethereumjs-util' {
  ...
  // Note: The types are based on https://github.com/ethereumjs/ethereumjs-util/blob/9c4dbfefb166dc9762c19630a48f3f24f2a547a6/index.js#L150
  // as well as our specific needs seeing as how it doesn't contain all the possible types it can support.
  export function bufferToHex(
    buf: Buffer | Uint8Array | string | number | null | undefined
  ): string
